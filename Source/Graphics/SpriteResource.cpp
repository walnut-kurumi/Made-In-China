...
{
	ID3D11DeviceContext* immediate_context = Graphics::Ins().GetDeviceContext();
...
// シェーダーリソースビューの設定
void SpriteResource::SetShaderResourceView(const Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& srv, int texWidth, int texHeight)
{
