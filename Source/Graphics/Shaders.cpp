...
void Shaders::Init(ID3D11Device* device)
{
	...
	//afterimage
	{
		...
		afterimage.InitCSO(device, inputElementDesc, ARRAYSIZE(inputElementDesc),
			"shader\\obj\\AfterimageVS.cso", "shader\\obj\\AfterimagePS.cso"
		);
	}	
	// outlineシェーダ
	{
		...
		outline.InitCSO(device, inputElementDesc, ARRAYSIZE(inputElementDesc),
			"shader\\obj\\outlineVSS.cso", "shader\\obj\\outlinePSS.cso"
		);
	}
