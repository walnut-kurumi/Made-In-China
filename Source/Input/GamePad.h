...
public:
	...
	static const GamePadButton BTN_LEFT_SHOULDER	= (1 << 12); // 手前
	static const GamePadButton BTN_RIGHT_SHOULDER	= (1 << 13); // 手前
	static const GamePadButton BTN_LEFT_TRIGGER		= (1 << 14); // 奥
	static const GamePadButton BTN_RIGHT_TRIGGER	= (1 << 15); // 奥
